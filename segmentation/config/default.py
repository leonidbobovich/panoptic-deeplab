...
_C.MODEL.BACKBONE.USE_DEEP_STEM = True
_C.MODEL.BACKBONE.DEEP_STEM = (32, 16, 16)
_C.MODEL.BACKBONE.INPUT_CHANNELS = 64
...
_C.DATASET.PRE_AUG = None
_C.DATASET.USE_TF_TRANSFORM = True

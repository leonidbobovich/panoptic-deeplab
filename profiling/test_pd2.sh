...
-onnx-define-symbol=batch,1 -onnx-define-symbol=unk__80,1 -time-passes -time=60 -aic-perf-warnings -aic-perf-metrics -device-id=0  \
${Q_FLAGS}\
 "
[ "${TRACE}" == "1" ] && COMPILE_FLAGS="${COMPILE_FLAGS}"
